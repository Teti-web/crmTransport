    ...
    <section className='home'>
     ...
     <div id='login' className='forms'>
        ...
        <div className='content'>
          ...
          <div className="field-wrapper">
            <input type="password" name="password" placeholder="password" onChange={changeHandler} autocomplete="new-password"/>
          ...
          {/* <Link className="psw" to='/forgotpassword'>Forgot Password?</Link> */}
          <Link className="signup" to='/register'>Not a user? Sign up</Link>
        </div>
        </div>
    </div>
    </section>
